...
func main() {
	...
	restricted := router.Group("/r", AuthMiddleware)
	router.POST("/addUser", AddUser)

	router.POST("/login", Login)

	restricted.GET("/profile", GetProfileDetails)
	restricted.POST("/changepassword", ChangePwd)
...
func GetProfileDetails(ctx *gin.Context) {
